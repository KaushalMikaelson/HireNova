...
import { TrendingDown, TrendingUp, BriefcaseIcon, Brain } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { LineChart, ResponsiveContainer, BarChart, XAxis, YAxis, CartesianGrid, Tooltip, Bar } from "recharts";
...
const DashboardView = ({ insights }: { insights: any }) => {
    ...
    const getMarketOutlookInfo = (outlook: string) => {
        switch (outlook.toLowerCase()) {
            case "positive": return { icon: TrendingUp, color: "text-green-600" };
            case "neutral": return { icon: LineChart, color: "text-yellow-600" };
            case "negative": return { icon: TrendingDown, color: "text-red-600" };
                    ...
                    <div className="h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={salaryData}>
                                ...
                                <Bar dataKey="median" fill="#82ca9d" name="Median Salary (K)" />
                                <Bar dataKey="max" fill="#5ce0e0" name="Max Salary (K)" />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
                <Card className="w-full">
                    <CardHeader>
                        ...
                        <CardDescription>Key trends in the industry</CardDescription>
                    </CardHeader>
                    <CardContent>
