...
export async function saveQuizResult(
    ...
    if(wrongAnswers.length > 0){
        ...
        const improvementPrompt = `
            ...
            Focuse on the knowledge gap revealed by the wrong answers.
            Keep the response under 2 sentences and make it encouraging.
            Don't explicitly mention the mistakes, instead focus on what to learn and what the user should do to improve.
            `;
            ...
            try{
                ...
                improvementTip = result.choices[0].message.content!;
